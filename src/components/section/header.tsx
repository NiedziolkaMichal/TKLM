  ...
  return (
    <>
      <section className={styles.header + (mobileNavOpen ? " " + styles.headerMobile : "")}>
        ...
        <a className={styles.headerLogo + (mobileNavOpen ? " " + styles.headerLogoMobile : "")} href={process.env.NEXT_PUBLIC_ABSOLUTE_URL}>
          <Logo aria-label={process.env.NEXT_PUBLIC_WEBSITE_NAME} />
        </a>
